...
const fileFilter = (
  ...
  if (file.fieldname === "profileImage" || file.fieldname === "avatar") {
    ...
    cb(
      new AppError(
        "Unexpected field. Only 'profileImage' and 'avatar' are allowed.",
        400
      )
    );
  }
...
// Multer instance for multiple fields (profileImage and avatar)
...
export const handleProfileImageUploadError = (multerMiddleware: any) => {
