 ...
 * @body    standUpPouch (required if cart has STAND_UP_POUCH items) - { capsuleCount?: 60|120 (optional, fallback), itemQuantities: [{ productId: string, quantity: number, capsuleCount?: 60|120, planDays?: 60|120 }] }
 ...
 * @note    STAND_UP_POUCH: Each product in itemQuantities can have its own capsuleCount/planDays. If not provided per product, falls back to top-level capsuleCount/planDays or defaults to 60.
