...
interface CreateLandingPageData {
  heroSection: {
    media: {
      type: "image" | "video";
      url: string;
      alt?: string; // Simple string for now
      sortOrder?: number;
    };
...
class LandingPageService {
  ...
  async createLandingPage(
    ...
    const landingPageData: any = {
      ...
      heroSection: {
        ...data.heroSection,
        title: typeof data.heroSection.title === "string" 
        ...
        media: {
          ...
          alt: data.heroSection.media.alt
            ? (typeof data.heroSection.media.alt === "string"
                ? { en: data.heroSection.media.alt }
                : data.heroSection.media.alt)
            : undefined,
        },
      },
    };
    ...
    if (data.membershipSection) {
      landingPageData.membershipSection = {
        ...
        title: typeof data.membershipSection.title === "string"
    ...
    if (data.productCategorySection) {
      landingPageData.productCategorySection = {
        title: typeof data.productCategorySection.title === "string"
    ...
    if (data.missionSection) {
      landingPageData.missionSection = {
        ...
        title: typeof data.missionSection.title === "string"
    ...
    if (data.featuresSection && data.featuresSection.features) {
      landingPageData.featuresSection = {
        title: typeof data.featuresSection.title === "string"
    ...
    if (data.designedByScienceSection && data.designedByScienceSection.steps) {
      landingPageData.designedByScienceSection = {
        title: typeof data.designedByScienceSection.title === "string"
    ...
    if (data.customerResultsSection) {
      landingPageData.customerResultsSection = {
        title: typeof data.customerResultsSection.title === "string"
    ...
    if (data.blogSection) {
      landingPageData.blogSection = {
        title: typeof data.blogSection.title === "string"
    ...
    if (data.faqSection && data.faqSection.faqs) {
      landingPageData.faqSection = {
        title: typeof data.faqSection.title === "string"
  ...
  async updateLandingPage(
    ...
    if (data.heroSection) {
      if (data.heroSection.media) {
        ...
        // Convert alt string to I18n format
        if (data.heroSection.media.alt !== undefined) {
          if (typeof data.heroSection.media.alt === "string") {
            mediaUpdate.alt = { en: data.heroSection.media.alt };
          } else {
            mediaUpdate.alt = data.heroSection.media.alt;
          }
        }
      ...
      if (data.heroSection.title) {
        ...
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.heroSection.title as any) = typeof data.heroSection.title === "string"
          ? { ...titleObj, en: data.heroSection.title }
          : { ...titleObj, ...(data.heroSection.title as Record<string, any>) };
      }
      if (data.heroSection.description !== undefined) {
        ...
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.heroSection.description as any) = typeof data.heroSection.description === "string"
          ? { ...descObj, en: data.heroSection.description }
          : { ...descObj, ...(data.heroSection.description as Record<string, any>) };
      }
    }
    ...
    if (data.membershipSection) {
      ...
      if (data.membershipSection.backgroundImage !== undefined) {
        (landingPage.membershipSection as any).backgroundImage = data.membershipSection.backgroundImage;
      }
      
      if (data.membershipSection.title) {
        const existingTitle = (landingPage.membershipSection as any)?.title;
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.membershipSection as any).title = typeof data.membershipSection.title === "string"
          ? { ...titleObj, en: data.membershipSection.title }
          : { ...titleObj, ...(data.membershipSection.title as Record<string, any>) };
      }
      
      if (data.membershipSection.description !== undefined) {
        const existingDesc = (landingPage.membershipSection as any)?.description;
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.membershipSection as any).description = typeof data.membershipSection.description === "string"
          ? { ...descObj, en: data.membershipSection.description }
          : { ...descObj, ...(data.membershipSection.description as Record<string, any>) };
      }
    }
    ...
    if (data.howItWorksSection) {
      if (data.howItWorksSection.steps) {
        const existingSteps = (landingPage.howItWorksSection as any)?.steps || [];
        const updatedSteps = data.howItWorksSection.steps.map((step, index) => {
          ...
          return {
            image: step.image !== undefined ? step.image : (existingStep.image || ""),
            title: step.title
            ...
            order: step.order !== undefined ? step.order : (existingStep.order !== undefined ? existingStep.order : index),
          };
        });
    ...
    if (data.productCategorySection) {
      ...
      if (data.productCategorySection.title) {
        const existingTitle = (landingPage.productCategorySection as any)?.title;
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.productCategorySection as any).title = typeof data.productCategorySection.title === "string"
          ? { ...titleObj, en: data.productCategorySection.title }
          : { ...titleObj, ...(data.productCategorySection.title as Record<string, any>) };
      }
      
      if (data.productCategorySection.description !== undefined) {
        const existingDesc = (landingPage.productCategorySection as any)?.description;
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.productCategorySection as any).description = typeof data.productCategorySection.description === "string"
          ? { ...descObj, en: data.productCategorySection.description }
          : { ...descObj, ...(data.productCategorySection.description as Record<string, any>) };
      }
    }
    ...
    if (data.missionSection) {
      ...
      if (data.missionSection.backgroundImage !== undefined) {
        (landingPage.missionSection as any).backgroundImage = data.missionSection.backgroundImage;
      }
      
      if (data.missionSection.title) {
        const existingTitle = (landingPage.missionSection as any)?.title;
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.missionSection as any).title = typeof data.missionSection.title === "string"
          ? { ...titleObj, en: data.missionSection.title }
          : { ...titleObj, ...(data.missionSection.title as Record<string, any>) };
      }
      
      if (data.missionSection.description !== undefined) {
        const existingDesc = (landingPage.missionSection as any)?.description;
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.missionSection as any).description = typeof data.missionSection.description === "string"
          ? { ...descObj, en: data.missionSection.description }
          : { ...descObj, ...(data.missionSection.description as Record<string, any>) };
      }
    }
    ...
    if (data.featuresSection) {
      if (data.featuresSection.title) {
        ...
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.featuresSection as any).title = typeof data.featuresSection.title === "string"
          ? { ...titleObj, en: data.featuresSection.title }
          : { ...titleObj, ...(data.featuresSection.title as Record<string, any>) };
      }
      ...
      if (data.featuresSection.description !== undefined) {
        ...
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.featuresSection as any).description = typeof data.featuresSection.description === "string"
          ? { ...descObj, en: data.featuresSection.description }
          : { ...descObj, ...(data.featuresSection.description as Record<string, any>) };
      }
      
      if (data.featuresSection.features) {
        const existingFeatures = (landingPage.featuresSection as any)?.features || [];
        const updatedFeatures = data.featuresSection.features.map((feature, index) => {
          ...
          return {
            icon: feature.icon !== undefined ? feature.icon : (existingFeature.icon || ""),
            title: feature.title
            ...
            description: feature.description !== undefined
              ? (typeof feature.description === "string"
                  ...
                  : { ...descObj, ...(feature.description as Record<string, any>) })
              : (existingFeature.description || {}),
            order: feature.order !== undefined ? feature.order : (existingFeature.order !== undefined ? existingFeature.order : index),
          };
        });
    ...
    if (data.designedByScienceSection) {
      if (data.designedByScienceSection.title) {
        ...
        const existingTitle = (landingPage.designedByScienceSection as any)?.title;
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.designedByScienceSection as any).title = typeof data.designedByScienceSection.title === "string"
          ? { ...titleObj, en: data.designedByScienceSection.title }
          : { ...titleObj, ...(data.designedByScienceSection.title as Record<string, any>) };
      }
      ...
      if (data.designedByScienceSection.description !== undefined) {
        ...
        const existingDesc = (landingPage.designedByScienceSection as any)?.description;
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.designedByScienceSection as any).description = typeof data.designedByScienceSection.description === "string"
          ? { ...descObj, en: data.designedByScienceSection.description }
          : { ...descObj, ...(data.designedByScienceSection.description as Record<string, any>) };
      }
      
      if (data.designedByScienceSection.steps) {
        const existingSteps = (landingPage.designedByScienceSection as any)?.steps || [];
        const updatedSteps = data.designedByScienceSection.steps.map((step, index) => {
          const existingStep: any = existingSteps[index] || {};
          const existingTitle = existingStep.title;
          const existingDesc = existingStep.description;
          const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
    ...
    if (data.customerResultsSection) {
      ...
      if (data.customerResultsSection.title) {
        const existingTitle = (landingPage.customerResultsSection as any)?.title;
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.customerResultsSection as any).title = typeof data.customerResultsSection.title === "string"
          ? { ...titleObj, en: data.customerResultsSection.title }
          : { ...titleObj, ...(data.customerResultsSection.title as Record<string, any>) };
      }
      
      if (data.customerResultsSection.description !== undefined) {
        const existingDesc = (landingPage.customerResultsSection as any)?.description;
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.customerResultsSection as any).description = typeof data.customerResultsSection.description === "string"
          ? { ...descObj, en: data.customerResultsSection.description }
          : { ...descObj, ...(data.customerResultsSection.description as Record<string, any>) };
      }
    }
    ...
    if (data.blogSection) {
      ...
      if (data.blogSection.title) {
        ...
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.blogSection as any).title = typeof data.blogSection.title === "string"
          ? { ...titleObj, en: data.blogSection.title }
          : { ...titleObj, ...(data.blogSection.title as Record<string, any>) };
      }
      
      if (data.blogSection.description !== undefined) {
        const existingDesc = (landingPage.blogSection as any)?.description;
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.blogSection as any).description = typeof data.blogSection.description === "string"
          ? { ...descObj, en: data.blogSection.description }
          : { ...descObj, ...(data.blogSection.description as Record<string, any>) };
      }
    }
    ...
    if (data.faqSection) {
      if (data.faqSection.title) {
        ...
        const titleObj = existingTitle && typeof existingTitle === "object" && !Array.isArray(existingTitle) ? existingTitle as Record<string, any> : {};
        (landingPage.faqSection as any).title = typeof data.faqSection.title === "string"
          ? { ...titleObj, en: data.faqSection.title }
          : { ...titleObj, ...(data.faqSection.title as Record<string, any>) };
      }
      ...
      if (data.faqSection.description !== undefined) {
        ...
        const descObj = existingDesc && typeof existingDesc === "object" && !Array.isArray(existingDesc) ? existingDesc as Record<string, any> : {};
        (landingPage.faqSection as any).description = typeof data.faqSection.description === "string"
          ? { ...descObj, en: data.faqSection.description }
          : { ...descObj, ...(data.faqSection.description as Record<string, any>) };
      }
      ...
      if (data.faqSection.faqs) {
        ...
        const updatedFAQs = data.faqSection.faqs.map((faq, index) => {
          ...
          const questionObj = existingQuestion && typeof existingQuestion === "object" && !Array.isArray(existingQuestion) ? existingQuestion as Record<string, any> : {};
          const answerObj = existingAnswer && typeof existingAnswer === "object" && !Array.isArray(existingAnswer) ? existingAnswer as Record<string, any> : {};
          ...
          return {
            ...
            answer: faq.answer !== undefined
              ...
              : (existingFAQ.answer || {}),
            order: faq.order !== undefined ? faq.order : (existingFAQ.order !== undefined ? existingFAQ.order : index),
          };
        });
